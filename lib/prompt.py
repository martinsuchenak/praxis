def _build_system_prompt():
    ...
    prompt += "When writing files, include a brief description: write_file(path, content, description=\"what this file is for\"). These descriptions appear in your tick file listing.\n\n"
